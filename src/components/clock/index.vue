<template>
	<!-- 打卡 -->
	<div class="dialog-main clock-dialog " :class="{recordshow:isShow}">
		<div class="dialog-bg" @click="clockhidden"></div>
		<div class="dialog-content clock-content">
			<div class="title">打卡 <i @click="clockhidden" class="iconfont icon-guanbi"></i></div>
			<form @submit="formSubmit">
				<div class="main">
					...
					<div class="img">
						...
						<p class="opimg" @click="chooseimg">添加图片</p>
					</div>
