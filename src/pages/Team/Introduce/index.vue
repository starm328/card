<template>
	<div class="team-introduct-warp">
		<div class="stm-cell  team-introduct-list">
			<div class="cell-warp">
				<div class="cell-left team-introduct-tit">所属行业：</div>
		...
		<div class="stm-cell  team-introduct-list  stm-m10-t">
			<div class="cell-warp">
				<div class="cell-left team-introduct-tit">领导人：</div>
				<div class="cell-main team-introduct-main">
		...
		<div class="stm-cell  team-introduct-list">
			<div class="cell-warp">
				<div class="cell-left team-introduct-tit">微信二维码</div>
				<div class="cell-main team-introduct-main">
					<input type="hidden" name="" style="width:0;min-height:0;height:0;">
					<img :src="item" class="tempFilePaths" v-for="(item,index) in code" :key="index"  @click="choosecode">
					<p class="opimg" @click="choosecode" >添加二维码</p>
				</div>
			</div>
		</div>
		<div class="stm-cell  team-introduct-list">
			<div class="cell-warp">
				<div class="cell-left team-introduct-tit">团队介绍：</div>
				<div class="cell-main team-introduct-main">
					<input type="hidden" name="" style="width:0;min-height:0;height:0;">
		...
		<div class="stm-cell  team-introduct-list stm-m10-t">
			<div class="cell-warp">
				<div class="cell-left team-introduct-tit">图片：</div>
				<div class="cell-main team-introduct-main">
					<input type="hidden" name="" style="width:0;min-height:0;height:0;">
		...
		<div class="stm-cell  team-introduct-list stm-m10-t">
			<div class="cell-warp">
				<div class="cell-left team-introduct-tit">视频：</div>
				<div class="cell-main team-introduct-main">
					<input type="hidden" name="" style="width:0;min-height:0;height:0;">
...
export default {
	...
	methods:{
		over() {
			wx.navigateTo({
			  url: '/pages/Team/Space/List/main'
			})
		},
		choosecode() {
			var _this =this
